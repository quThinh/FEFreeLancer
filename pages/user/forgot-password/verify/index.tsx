	...
	return (
		<AuthLayout>
			...
			<div className="w-[400px] p-8 pb-20 bg-white items-center flex flex-col gap-4">
				...
				<p className="text-base text-center text-neutral-80 font-medium">  Gửi yêu cầu lấy lại mật khẩu thành công, kiểm tra email để xác nhận tài khoản trước khi đăng nhập.</p>
